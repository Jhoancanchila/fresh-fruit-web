      ...
      <div className=' w-11/12 max-w-[500px] sm:px-10 py-20 px-5 py-10'>
        ...
        <div className='mt-8'>
          ...
          <div className='mt-8 flex flex-col gap-y-4'>
            <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-[#EF8043] rounded-xl text-white font-bold text-lg'>Sign in</button>
            <button
